...
export default function Auth() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Email confirmation is enabled on this project, so signUp returns a user
      // but no session. Navigating to /dashboard here would bounce straight back
      // to /auth and look like an instant logout.
      toast({
        title: 'Check your email',
        description: 'We sent you a confirmation link. Confirm your address, then log in.',
      });
    } else {
      toast({
